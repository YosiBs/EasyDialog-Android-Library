...
public class UnderlineApplier implements StyleApplier {
    private static final String TAG_REGEX = "<u>(.*?)</u>";

    @Override
    public void apply(SpannableString spannableString, String input) {
        applyStyle(spannableString, input, TAG_REGEX, new UnderlineSpan());
    }
